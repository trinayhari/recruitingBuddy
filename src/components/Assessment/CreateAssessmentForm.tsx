...
interface CreateAssessmentFormProps {
  onSuccess: (assessment: { id: string; shareableToken: string; shareableLink: string }) => void
  onCancel: () => void
}

export default function CreateAssessmentForm({ onSuccess, onCancel }: CreateAssessmentFormProps) {
  ...
  return (
    <div className="bg-white border border-neutral-200 rounded-lg shadow-sm p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="assessment-title" className="block text-body-sm font-medium mb-2 text-neutral-900">
            Assessment Title <span className="text-neutral-500 font-normal">(required)</span>
          </label>
          <input
            type="text"
            id="assessment-title"
        ...
        <div>
          <label htmlFor="assessment-content" className="block text-body-sm font-medium mb-2 text-neutral-900">
            Assessment Requirements <span className="text-neutral-500 font-normal">(required)</span>
          </label>
          <textarea
